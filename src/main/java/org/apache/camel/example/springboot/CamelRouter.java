...
public class CamelRouter extends RouteBuilder {
    ...
    public void configure() throws Exception {
        ...
        rest("/pets").description("Pet REST service")
            ...
            .get("/{id}").description("Find pet by ID")
            .outType(Pet.class)
            .param().name("id").type(path).description("The ID of the pet").dataType("integer").endParam()
            .responseMessage().code(200).message("Pet successfully returned").endResponseMessage()
            .to("direct:start");
